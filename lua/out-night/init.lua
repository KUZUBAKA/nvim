...
local no_transparent_highlights = {
 ...
 HlFilePath       = { fg = colors.white, bg = colors.navy },
 HlFileType       = { fg = colors.white, bg = colors.navy },
 HlSepFPR         = { fg = colors.skyblue, bg = colors.navy },
 ...
 HlDiagnosticsSep = { fg = colors.blue_dark, bg = colors.navy },
 HlSelCharsSep = { fg = colors.sky_blue, bg = colors.navy },
